...
public class InvListener extends JFrame implements ActionListener{
...
public void generatemap(){
	...
	public InvListener(Tournament Tournament,HarryPotterView HarryPotterView,FirstTask FirstTask){
	...
	public void actionPerformed(ActionEvent e) {
		FirstTask.usePotion((Potion) ((JReferencingButton) e.getSource()).getValue());
