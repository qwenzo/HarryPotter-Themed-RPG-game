...
public class InvListenerT3 implements ActionListener {
	private Tournament Tournament;
	private HarryPotterView HarryPotterView;
	private ThirdTask ThirdTask;
	
	public InvListenerT3(Tournament Tournament,HarryPotterView HarryPotterView,ThirdTask ThirdTask){
	...
	public void actionPerformed(ActionEvent e) {
		ThirdTask.usePotion((Potion) ((JReferencingButton) e.getSource()).getValue());
