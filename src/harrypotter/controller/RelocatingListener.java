...
public class RelocatingListener extends JFrame implements ActionListener{
	private FirstTask FirstTask;
	private Tournament Tournament;
	private HarryPotterView HarryPotterView;
	private useSpellsListener2 useSpellsListener2;
...
public void generatemap(){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(x==FirstTask.getTargetPoint(Direction.FORWARD).getX()&& y==FirstTask.getTargetPoint(Direction.FORWARD).getY()){
			...
			String[] data= new String[((RelocatingSpell) useSpellsListener2.getJReferencingButton()).getRange()+1];
			for(int i =0;i<=((RelocatingSpell) useSpellsListener2.getJReferencingButton()).getRange();i++){
			...
			m.addActionListener(new Relocate2Listener(FirstTask, Tournament, HarryPotterView, useSpellsListener2, this));
			target.add(List1);
			target.add(List2);
		...
		else if(x==FirstTask.getTargetPoint(Direction.BACKWARD).getX()&& y==FirstTask.getTargetPoint(Direction.BACKWARD).getY()){
		...
		else if(x==FirstTask.getTargetPoint(Direction.LEFT).getX()&& y==FirstTask.getTargetPoint(Direction.LEFT).getY()){
		...
		else if(x==FirstTask.getTargetPoint(Direction.RIGHT).getX()&& y==FirstTask.getTargetPoint(Direction.RIGHT).getY()){
	...
	public  RelocatingListener(FirstTask FirstTask, Tournament Tournament,HarryPotterView HarryPotterView, useSpellsListener2 useSpellsListener2 ){
		this.FirstTask=FirstTask;
		this.Tournament=Tournament;
		this.HarryPotterView=HarryPotterView;
		this.useSpellsListener2=useSpellsListener2;
