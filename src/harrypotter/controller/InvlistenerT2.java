...
public class InvlistenerT2 extends JFrame implements ActionListener {
	private Tournament Tournament;
	private HarryPotterView HarryPotterView;
	private SecondTask SecondTask;
	
	public InvlistenerT2(Tournament Tournament,HarryPotterView HarryPotterView,SecondTask SecondTask){
	...
	public void actionPerformed(ActionEvent e) {
		SecondTask.usePotion((Potion) ((JReferencingButton) e.getSource()).getValue());
		JOptionPane.showMessageDialog(null, "you just used "+((Potion) ((JReferencingButton) e.getSource()).getValue()).getName()+" Potion"+ " and got intelligence heal by"+((Potion) ((JReferencingButton) e.getSource()).getValue()).getAmount());
		generatemapT2();
