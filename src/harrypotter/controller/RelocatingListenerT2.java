...
public class RelocatingListenerT2 extends JFrame implements ActionListener {
	private SecondTask SecondTask;
	private Tournament Tournament;
	private HarryPotterView HarryPotterView;
	private useSpellListenerT2 useSpellListenerT2;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(x==SecondTask.getTargetPoint(Direction.FORWARD).getX()&& y==SecondTask.getTargetPoint(Direction.FORWARD).getY()){
			...
			String[] data= new String[((RelocatingSpell) useSpellListenerT2.getJReferencingButton()).getRange()+1];
			for(int i =0;i<=((RelocatingSpell) useSpellListenerT2.getJReferencingButton()).getRange();i++){
			...
			m.addActionListener(new Relocate2ListenerT2(SecondTask, Tournament, HarryPotterView, useSpellListenerT2, this));
			target.add(List1);
			target.add(List2);
		...
		else if(x==SecondTask.getTargetPoint(Direction.BACKWARD).getX()&& y==SecondTask.getTargetPoint(Direction.BACKWARD).getY()){
		...
		else if(x==SecondTask.getTargetPoint(Direction.LEFT).getX()&& y==SecondTask.getTargetPoint(Direction.LEFT).getY()){
		...
		else if(x==SecondTask.getTargetPoint(Direction.RIGHT).getX()&& y==SecondTask.getTargetPoint(Direction.RIGHT).getY()){
	...
	public  RelocatingListenerT2(SecondTask SecondTask, Tournament Tournament,HarryPotterView HarryPotterView, useSpellListenerT2 useSpellListenerT2 ){
		this.SecondTask=SecondTask;
		this.Tournament=Tournament;
		this.HarryPotterView=HarryPotterView;
		this.useSpellListenerT2=useSpellListenerT2;
